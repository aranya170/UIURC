<footer class="relative text-white bg-[#262626] lg:bg-transparent h-auto lg:h-[494px] mt-20">
    <!-- Background SVG (Hidden in mobile view) -->
    <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="494" fill="none" preserveAspectRatio="none"
        viewBox="0 0 1410 494" class="sm:hidden xs:hidden lg:block absolute bottom-0 left-0 p-[15px] -z-10">
        <path
            d="M0 10C0 4.477 4.47246 7.98454e-09 9.98987 7.98454e-09H373.423C375.112 -6.75235e-05 376.772 0.428241 378.251 1.24491C379.729 2.06159 380.976 3.23998 381.876 4.67L406.842 44.338C407.742 45.7679 408.989 46.9463 410.467 47.763C411.945 48.5796 413.606 49.008 415.294 49.008H1242.78C1246.29 49.008 1249.54 50.851 1251.35 53.863L1269.02 83.359C1269.91 84.8395 1271.17 86.0646 1272.67 86.9153C1274.17 87.766 1275.87 88.2134 1277.59 88.214H1400.01C1405.52 88.214 1410 92.691 1410 98.214V484C1410 489.523 1405.52 494 1400.01 494H9.98987C4.47246 494 0 489.523 0 484V10Z"
            fill="#262626" />
    </svg>
    <!-- Nut SVG positioned in top right corner (Hidden in mobile view) -->
    <svg fill="#000000" width="15px" height="15px" class="absolute top-[110px] right-[25px] z-10 lg:block hidden"
    ...
    <svg fill="#000000" width="15px" height="15px" class="absolute bottom-[25px] right-[25px] z-10 lg:block hidden"
        viewBox="0 0 24 24" id="nut-2" data-name="Flat Color" xmlns="http://www.w3.org/2000/svg">
        <path id="primary"
            d="M20,6.2,13,2.26a2,2,0,0,0-2,0L4,6.19A2,2,0,0,0,3,7.94v8.12A2,2,0,0,0,4,17.8l7,3.94a2,2,0,0,0,2,0l7-3.93a2,2,0,0,0,1-1.75V7.94A2,2,0,0,0,20,6.2ZM12,15a3,3,0,1,1,3-3A3,3,0,0,1,12,15Z"
            style="fill: #fff;"></path>
    </svg>
    <svg fill="#000000" width="15px" height="15px" class="absolute bottom-[25px] left-[25px] z-10 lg:block hidden"
        viewBox="0 0 24 24" id="nut-2" data-name="Flat Color" xmlns="http://www.w3.org/2000/svg">
        <path id="primary"
            d="M20,6.2,13,2.26a2,2,0,0,0-2,0L4,6.19A2,2,0,0,0,3,7.94v8.12A2,2,0,0,0,4,17.8l7,3.94a2,2,0,0,0,2,0l7-3.93a2,2,0,0,0,1-1.75V7.94A2,2,0,0,0,20,6.2ZM12,15a3,3,0,1,1,3-3A3,3,0,0,1,12,15Z"
            style="fill: #fff;"></path>
    </svg>
    <svg fill="#000000" width="15px" height="15px" class="absolute top-[25px] left-[25px] z-10 lg:block hidden"
        viewBox="0 0 24 24" id="nut-2" data-name="Flat Color" xmlns="http://www.w3.org/2000/svg">
        <path id="primary"
            d="M20,6.2,13,2.26a2,2,0,0,0-2,0L4,6.19A2,2,0,0,0,3,7.94v8.12A2,2,0,0,0,4,17.8l7,3.94a2,2,0,0,0,2,0l7-3.93a2,2,0,0,0,1-1.75V7.94A2,2,0,0,0,20,6.2ZM12,15a3,3,0,1,1,3-3A3,3,0,0,1,12,15Z"
            style="fill: #fff;"></path>
    </svg>
    <div class="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-16 pt-12 sm:pt-24 pb-8 sm:pb-12 relative z-10">
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
            <!-- Club Info -->
            <div>
                <img src="/assets/img/logo/Icon.png" class="h-16 w-16 sm:h-20 sm:w-20 mx-auto sm:mx-0"
                    alt="UIU Robotics Club Logo" srcset="">
                <h3 class="text-xl sm:text-2xl font-bold mb-4 text-center sm:text-left">UIU Robotics Club</h3>
                <p class="text-gray-300 text-sm sm:text-base text-center sm:text-left">Fostering innovation and
                    creativity through robotics and technology at United International University.</p>
            </div>
            <!-- Quick Links -->
            <div>
                <h3 class="text-lg sm:text-xl font-semibold mb-4 text-center sm:text-left">Quick Links</h3>
                <ul class="space-y-2 text-sm sm:text-base text-center sm:text-left">
                    ...
                    <li><a href="/AboutUs/index.php" class="hover:text-blue-400 transition">About Us</a></li>
                    <li><a href="/All_Events/index.php" class="hover:text-blue-400 transition">Events</a></li>
                    <li><a href="tel: +8801843-279875" class="hover:text-blue-400 transition">Contact</a></li>
                </ul>
            </div>
            <!-- Contact Info -->
            <div>
                <h3 class="text-lg sm:text-xl font-semibold mb-4 text-center sm:text-left">Contact Us</h3>
        ...
        <!-- Bottom Bar -->
        <div class="mt-6 sm:mt-8 pt-6 sm:pt-8 border-t border-white-700 text-center">
            <p class="text-white-400 text-sm sm:text-base">© 2025 UIU Robotics Club. All rights reserved.</p>
        </div>
    </div>
</footer>