<footer class="relative text-white bg-[#0c1723] lg:bg-transparent h-auto lg:h-[494px] mt-20">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
            ...
            <div>
                ...
                <div class="flex space-x-4 mt-4 justify-center sm:justify-start">
                    ...
                    <!-- Facebook -->
                    <a href="https://www.facebook.com/uiurobotics/" class="hover:text-blue-400 transition">
                        <svg class="w-15 h-15 sm:w-6 sm:h-6" fill="#ffffff" viewBox="0 0 50 50">
                            <path
                    ...
                    <!-- Linked In -->
                    <a href="https://www.linkedin.com/company/uiu-robotics/" class="hover:text-blue-400 transition">
                        <svg class="w-15 h-15 sm:w-6 sm:h-6" fill="#ffffff" viewBox="0 0 50 50">
                            <path
