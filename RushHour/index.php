...
<body>
    ...
    <section
        ...
        <div class="w-full sm:w-1/2 rounded-xl">
            <img class="rounded-xl w-full h-[400px] object-cover" src="\assets\img\Events\Rush_hour.jpg"
                alt="Research 101 Banner">
        </div>
        <div class="w-full sm:w-1/2 flex flex-col">
            <div class="my-6">
                <h1 class="text-2xl lg:text-4xl xl:text-[3.25rem] text-primary font-semibold">Rush Hour - Intra Robotics
                    Championship</h1>
                <p class="text-lg">Get Ready for the Ultimate Robotics Showdown!
                    Join us for an action-packed day of innovation, competition, and excitement at
                    Rush Hours: Intra University Robotics Championship,
                    Powered by UIU Robotics.</p>
            </div>
